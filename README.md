...
This AirBnB project is a complete web application, integrating database storage,
a back-end API, and front-end interfacing in a clone of AirBnB. The project is an ALX
Software Engineering Pragram team project. Each team comprise of two members.
The goal of the project is to deploy on a server a simple copy of the AirBnB website.

The entire project is in four stages of which this is the first stage.
This stage only implements the back-end console.


## Classes

The AirBnB project utilizes the following classes:
...
* **Henry AGYEMANG** <[dhokabeatz](https://github.com/dhokabeatz)>
